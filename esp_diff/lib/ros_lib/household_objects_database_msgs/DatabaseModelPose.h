...
namespace household_objects_database_msgs
{
  ...
  class DatabaseModelPose : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "household_objects_database_msgs/DatabaseModelPose"; };
    virtual const char * getMD5() override { return "6bc39ef48ca57cc7d4341cfc13a5a110"; };
