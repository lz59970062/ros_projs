...
namespace manipulation_msgs
{
  ...
  class SceneRegion : public ros::Msg
  {
    ...
    SceneRegion():
      cloud(),
      mask_length(0), st_mask(), mask(nullptr),
      image(),
      disparity_image(),
      cam_info(),
      roi_box_pose(),
    ...
    virtual const char * getType() override { return "manipulation_msgs/SceneRegion"; };
    virtual const char * getMD5() override { return "0a9ab02b19292633619876c9d247690c"; };
