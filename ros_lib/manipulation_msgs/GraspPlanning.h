...
static const char GRASPPLANNING[] = "manipulation_msgs/GraspPlanning";
  ...
  class GraspPlanningRequest : public ros::Msg
  {
    ...
    GraspPlanningRequest():
      ...
      grasps_to_evaluate_length(0), st_grasps_to_evaluate(), grasps_to_evaluate(nullptr),
    ...
    virtual const char * getMD5() override { return "077dca08a07415d82d6ab047890161f4"; };
  ...
  class GraspPlanningResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GRASPPLANNING; };
    virtual const char * getMD5() override { return "ff7a88c4aec40207164535a24dc9c440"; };
