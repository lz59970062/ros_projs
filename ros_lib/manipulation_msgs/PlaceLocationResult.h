...
namespace manipulation_msgs
{
  ...
  class PlaceLocationResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "manipulation_msgs/PlaceLocationResult"; };
    virtual const char * getMD5() override { return "8dd9edc3a2a98cab298ca81031224cda"; };
