...
namespace manipulation_msgs
{
  ...
  class GraspableObject : public ros::Msg
  {
    ...
    GraspableObject():
      reference_frame_id(""),
      potential_models_length(0), st_potential_models(), potential_models(nullptr),
      cluster(),
      region(),
      collision_name("")
    {
    ...
    virtual const char * getType() override { return "manipulation_msgs/GraspableObject"; };
    virtual const char * getMD5() override { return "e2efd13d8e2bbb4697a5d71f167bceaa"; };
