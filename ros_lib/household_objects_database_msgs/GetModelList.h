...
static const char GETMODELLIST[] = "household_objects_database_msgs/GetModelList";
  ...
  class GetModelListRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GETMODELLIST; };
    virtual const char * getMD5() override { return "6bdf0a866151f41b8876e73800929933"; };
  ...
  class GetModelListResponse : public ros::Msg
  {
    ...
    GetModelListResponse():
      return_code(),
      model_ids_length(0), st_model_ids(), model_ids(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return GETMODELLIST; };
    virtual const char * getMD5() override { return "81fac8c5d631e612bd9183a923572d53"; };
