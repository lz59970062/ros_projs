...
namespace household_objects_database_msgs
{
  ...
  class DatabaseScan : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "household_objects_database_msgs/DatabaseScan"; };
    virtual const char * getMD5() override { return "7edb7abec4973143a801c25c336b4bb1"; };
