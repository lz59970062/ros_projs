...
namespace household_objects_database_msgs
{
  ...
  class DatabaseModelPoseList : public ros::Msg
  {
    ...
    DatabaseModelPoseList():
      model_list_length(0), st_model_list(), model_list(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "household_objects_database_msgs/DatabaseModelPoseList"; };
    virtual const char * getMD5() override { return "f0bb2aa8d2ededee0ffe0f5d2107e099"; };
