...
static const char SAVESCAN[] = "household_objects_database_msgs/SaveScan";
  ...
  class SaveScanRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return SAVESCAN; };
    virtual const char * getMD5() override { return "492f49d320aa26325df5fb078c297fa5"; };
  ...
  class SaveScanResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return SAVESCAN; };
    virtual const char * getMD5() override { return "b49fccceeb56b964ed23601916a24082"; };
