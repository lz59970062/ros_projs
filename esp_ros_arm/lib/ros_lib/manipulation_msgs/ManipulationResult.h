...
namespace manipulation_msgs
{
  ...
  class ManipulationResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "manipulation_msgs/ManipulationResult"; };
    virtual const char * getMD5() override { return "85f8d010e045fcb335637fc8fc59184b"; };
