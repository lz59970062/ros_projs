...
namespace manipulation_msgs
{
  ...
  class ManipulationPhase : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "manipulation_msgs/ManipulationPhase"; };
    virtual const char * getMD5() override { return "2c824c847a35d8fd9277d324a3723378"; };
