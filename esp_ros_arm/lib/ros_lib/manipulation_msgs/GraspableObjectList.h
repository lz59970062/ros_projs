...
namespace manipulation_msgs
{
  ...
  class GraspableObjectList : public ros::Msg
  {
    ...
    GraspableObjectList():
      graspable_objects_length(0), st_graspable_objects(), graspable_objects(nullptr),
      image(),
      camera_info(),
    ...
    virtual const char * getType() override { return "manipulation_msgs/GraspableObjectList"; };
    virtual const char * getMD5() override { return "d67571f2982f1b7115de1e0027319109"; };
