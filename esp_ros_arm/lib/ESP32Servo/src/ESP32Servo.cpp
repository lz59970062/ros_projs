...
* sweep 270 degrees, so the lowest number in the published range for a particular servo
* represents an angle of 0 degrees, the middle of the range represents 90 degrees, and the top
* of the range represents 270 degrees. So for example, if the range is 1000us to 2000us,
* 1000us would equal an angle of 0, 1500us would equal 90 degrees, and 2000us would equal 270
...
void Servo::write(int value)
{
    ...
    {
        value = constrain(value, -270 / 2, 270 / 2);
        value = map(value, -270 / 2, 270 / 2, this->min, this->max);
    }
...
{
    return (map(readMicroseconds() + 1, this->min, this->max, -270 / 2, 270 / 2));
}
